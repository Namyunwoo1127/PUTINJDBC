package com.putin.jdbc.day01.student.controller;
import java.util.List;

import com.putin.jdbc.day01.student.model.ManageStudent;
import com.putin.jdbc.day01.student.model.Student;
import com.putin.jdbc.day01.student.view.ViewStudent;
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			case 5:
				...
				break;
			case 6:
				// 재평가 대상 확인할 학생 이름 입력 받음
				name = view.inputName();
				// 입력받은 이름으로 재평가 대상 여부 확인
				manage.checkRetakeEligibility(name);
				break;
			case 0:
